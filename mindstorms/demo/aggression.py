# Braitenberg Vehicle - Agressive Behaviour
...
while not stop_button.any():
    ...
    left_motor.run_forever(speed_sp=right_sensor_value, speed_regulation_enabled='on')
    right_motor.run_forever(speed_sp=left_sensor_value, speed_regulation_enabled='on')
    time.sleep(0.1)
